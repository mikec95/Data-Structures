...
const game = {
  ...
  printGoals: function (...args) {
    const score = args.length;
    console.log("Players: " + args + "\n" + "Goals: " + score);
  },

  mostLikelyToWin: function (a, b) {
    a < b && console.log(`${a} will win`);
    a > b && console.log(`${b} will win`);
  },
};
...
// QUESTION 6:
game.printGoals("leonard", "John");

// QUESTION 7:
game.mostLikelyToWin(team2Odds, team1Odds);
